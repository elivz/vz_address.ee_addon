...
class Vz_address_ft extends EE_Fieldtype {
    ...
    public function display_settings($settings)
    {
        ...
        $settings = array(
            array(
                'title' => lang('vz_address_display_name'),
                'fields' => array(
                    'vz_address_display_name' => array(
                        'type' => 'html',
                        'content' => form_radio('vz_address_display_name', 'y', $display_name, 'id="vz_address_display_name_yes"') . ' ' .
            ...
            array(
                'title' => lang('vz_address_display_previous'),
                'fields' => array(
                    'vz_address_display_previous' => array(
                        'type' => 'html',
                        'content' => form_radio('vz_address_display_previous', 'y', $display_previous, 'id="vz_address_display_previous_yes"') . ' ' .
                            form_label(lang('yes'), 'vz_address_display_previous_yes') .
                            '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' .
